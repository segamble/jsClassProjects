...
var herDinner = invitees.adults[2].dinnerChoice;
console.log("Lauren's appetizer is " +herDinner[0]+". She will be eating "+ herDinner[1] +
" for dinner and has selected "+ herDinner[2]+" as her dessert.");
...
jsWorkshop.classmates = ['Amanda', 'Vido', 'John', 'Gayla', 'Alex'];
